...
public class Skill_PinPanel_MagicCrest_Hide_Anim : StateMachineBehaviour {
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        {
            m_ParentSkillInfo =
                MecroMethod.CheckGetComponent<Skill_Interface>(animator.transform.parent);
        }
    }
